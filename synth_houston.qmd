...
dataprep.out <-
  dataprep(
    ...
    controls.identifier   = c(1:5, 7, 9, 11:12), #value of other control cities
...
png("Presentation/images/synth_tx_annualavg.png", 
...
```{r}
png("Presentation/images/synth_tx_monthlyavg.png",
    res=500, width=5, height=5, units="in")
...
## Monthly averages for Monday/Tuesday
...
## January averages for Mondays/Tuesdays
...
df5<-df4 |>
  ...
  mutate(time=ifelse(time>1, time-2, time))

opentime<-2
end<-max(df5$time)

df6 <-df5 |>
  select_at(vars(-contains("cubed"))) |>
  select_at(vars(-contains("squared"))) 

dataprep.out <-
  dataprep(
    df5,
    predictors            = colnames(df6)[6:28], #add linear, square, cubic weather
    dependent             = "pm25",
    unit.variable         = "add_num",
    time.variable         = "time",
    unit.names.variable   = "Address",
...
## February averages for Mondays/Tuesdays
...
## March averages for Mondays/Tuesdays
...
df5<-df4 |>
  ...
  mutate(time=ifelse(time>0, time-3, time)) |>
  select(where(~ any(. != 0))) #Removes columns with all zeroes (i.e. snowfall)
...
dataprep.out <-
  dataprep(
    df6,
    predictors            = colnames(df6)[c(6:10, 13:14, 17:22, 24:28)],
    dependent             = "pm25",
    unit.variable         = "add_num",
    time.variable         = "time",
    unit.names.variable   = "Address",
...
## April averages for Mondays/Tuesdays
...
dataprep.out <-
  dataprep(
    df6,
    predictors            = colnames(df6)[c(6:10, 12:13, 16:26)], #add linear, square, cubic weather
    dependent             = "pm25",
    unit.variable         = "add_num",
    time.variable         = "time",
    unit.names.variable   = "Address",
...
## May averages for Mondays/Tuesdays
...
dataprep.out <-
  dataprep(
    df6,
    predictors            = colnames(df6)[6:23], #add linear, square, cubic weather
    dependent             = "pm25",
    unit.variable         = "add_num",
    time.variable         = "time",
    unit.names.variable   = "Address",
...
## June averages for Mondays/Tuesdays
...
dataprep.out <-
  dataprep(
    df5,
    predictors            = colnames(df5)[6:23], #add linear, square, cubic weather
    dependent             = "pm25",
    unit.variable         = "add_num",
    time.variable         = "time",
    unit.names.variable   = "Address",
...
## July averages for Mondays/Tuesdays
...
## August averages for Mondays/Tuesdays
...
## September averages for Mondays/Tuesdays
...
## Oct averages for Mondays/Tuesdays
...
df5<-df4 |>
  ...
  select_at(vars(-contains("cubed"))) |>
  select_at(vars(-contains("squared"))) |>
  select_at(vars(-contains("Snow"))) |>
  select_at(vars(-contains("Qsm"))) |>
  select_at(vars(-contains("SWE")))
...
dataprep.out <-
  dataprep(
    df5,
    predictors            = colnames(df5)[6:22], #add linear, square, cubic weather
    dependent             = "pm25",
    unit.variable         = "add_num",
    time.variable         = "time",
    unit.names.variable   = "Address",
...
## Nov averages for Mondays/Tuesdays
...
dataprep.out <-
  dataprep(
    df5,
    predictors            = colnames(df5)[6:28], #add linear, square, cubic weather
    dependent             = "pm25",
    unit.variable         = "add_num",
    time.variable         = "time",
    unit.names.variable   = "Address",
...
## December averages for Mondays/Tuesdays
...
## Monthly averages for Saturdays/Sundays
...
## January averages for Saturdays/Sundays
...
## February averages for Saturdays/Sundays
...
## March averages for Saturdays/Sundays
...
## April averages for Saturdays/Sundays
...
dataprep.out <-
  dataprep(
    df6,
    predictors            = colnames(df6)[c(6:10, 13:14, 17:22, 24:26)],
    dependent             = "pm25",
    unit.variable         = "add_num",
    time.variable         = "time",
    unit.names.variable   = "Address",
...
## May averages for Saturdays/Sundays
...
## June averages for Saturdays/Sundays
...
## July averages for Saturdays/Sundays
...
df5<-df4 |>
  filter(month==7) |>
  mutate(time=interval(as.Date("2000-07-01"), date)/months(12)) |>
  mutate(time=ifelse(time>5, time-4, time)) |>
  select(where(~ any(. != 0))) |>
  select_at(vars(-contains("cubed"))) |>
  select_at(vars(-contains("squared"))) 
...
## August averages for Saturdays/Sundays
...
## September averages for Saturdays/Sundays
...
## Oct averages for Saturdays/Sundays
...
## Nov averages for Saturdays/Sundays
...
## December averages for Saturdays/Sundays

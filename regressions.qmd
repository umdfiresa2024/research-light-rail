...
cm1<-felm(pm25 ~ opentime:treatcity + opentime + treatcity +
                 PRECTOT + PRECSNO + QSH + RHOA + SPEED + TLML +
                 PRECTOT2 + PRECSNO2 + QSH2 + RHOA2 + SPEED2 + TLML2 |
            month + year, data=df2)

df3<-df2 |>
  mutate(contime=ifelse(time>12 & time<48,1,0))

cm2<-felm(pm25 ~ opentime:treatcity + opentime + treatcity +
          contime:treatcity + contime + 
          PRECTOT + PRECSNO + QSH + RHOA + SPEED + TLML +
          PRECTOT2 + PRECSNO2 + QSH2 + RHOA2 + SPEED2 + TLML2 |
            month + year, data=df3)
...
cm3<-felm(pm25 ~ opentime:treatcity + opentime + treatcity +
                 PRECTOT + PRECSNO + QSH + RHOA + SPEED + TLML +
                 PRECTOT2 + PRECSNO2 + QSH2 + RHOA2 + SPEED2 + TLML2 |
            month + year, data=df3)
```
...
cm4<-felm(pm25 ~ opentime:treatcity + opentime + treatcity +
                 PRECTOT + PRECSNO + QSH + RHOA + SPEED + TLML +
                 PRECTOT2 + PRECSNO2 + QSH2 + RHOA2 + SPEED2 + TLML2 |
            month + year, data=df2)
...
cm5<-felm(pm25 ~ opentime:treatcity + opentime + treatcity +
          contime:treatcity + contime + 
          PRECTOT + PRECSNO + QSH + RHOA + SPEED + TLML +
          PRECTOT2 + PRECSNO2 + QSH2 + RHOA2 + SPEED2 + TLML2 |
            month + year, data=df3)

stargazer(cm1, cm2, cm3, cm4, cm5, type="text", 
 dep.var.labels=c("PM25"), out="Output Tables/models_charlotte.txt")
```
...
cm6<-felm(log(pm25) ~ opentime:treatcity + opentime + treatcity +
            contime:treatcity + contime +
                 PRECTOT + PRECSNO + QSH + RHOA + SPEED + TLML +
                 PRECTOT2 + PRECSNO2 + QSH2 + RHOA2 + SPEED2 + TLML2 |
            month + year, data=df3)
...
hm2<-lm(pm25 ~ opentime:treatcity + opentime + treatcity +
                 PRECTOT + PRECSNO + QSH + RHOA + SPEED + TLML + 
                 PRECTOT2 + PRECSNO2 + QSH2 + RHOA2 + SPEED2 + TLML2 +
                 as.factor(month) + as.factor(year), data=df3)
```
...
summary(m2<-lm(log(pm25) ~ opentime:treatcity + opentime + treatcity +
                 PRECTOT + PRECSNO + QSH + RHOA + SPEED + TLML + 
                 PRECTOT2 + PRECSNO2 + QSH2 + RHOA2 + SPEED2 + TLML2 +
                 as.factor(month) + as.factor(year), data=df3))
...
pm5<-felm(log(pm25) ~ opentime:treatcity + opentime + treatcity +
          contime:treatcity + contime +
                 PRECTOT + PRECSNO + QSH + RHOA + SPEED + TLML + 
                 PRECTOT2 + PRECSNO2 + QSH2 + RHOA2 + SPEED2 + TLML2|
            month+year, data=df3)

...
myfe<-"| dow_my + Address"
dafe<- "| dow_a + Address"
dafem<-"| dow_a + Address + month + year"
...
f<-as.formula(paste("pm25 ~ operating:treatcity + ", wcontrols, dafem))
...
#| message: false
#| warning: false
f<-as.formula(paste("pm25 ~ operating:treatcity:dow + ", wcontrols, dafe))

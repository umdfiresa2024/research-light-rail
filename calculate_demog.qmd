...
```{r}
library("terra")
c1<-vect("Twin Cities Shapefiles/roads_1km_buff/roads_1km_buff.shp")
c2<-vect("Charlotte Shapefiles/roads_1km_buff/roads_1km_buff.shp")
c3<-vect("Phoenix Shapefiles/roads_1km_buff/roads_1km_buff.shp")
c4<-vect("Houston Shapefiles/roads_1km_buff/roads_1km_buff.shp")

cities<-rbind(c1,c2,c3,c4)
```
...
cities_coef<-cbind(cities, coefdf)
```
...
```{r}
png(filename="samplemap.png", width=1000, height=700, units="px")

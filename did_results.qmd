...
#| message: false
#| warning: false
f<-as.formula(paste("pm25 ~ operating:treatcity:dow + operating + operating:dow + ", wcontrols, dafem))
m4 <- feols(f, cluster = "Address", data = df)
...
f<-as.formula(paste("pm25 ~ operating:treatcity + operating + ", wcontrols, dafe))
m6 <- feols(f, cluster = "Address", data = df)

f<-as.formula(paste("pm25 ~ operating:treatcity + operating + ", 
                    wcontrols, dafem))
m7 <- feols(f, cluster = "Address", data = df)

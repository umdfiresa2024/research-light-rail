...
## DiD Results for Charlotte, NC {.smaller}
...
\end{table}
```
## DiD Results for Charlotte, NC in Each Day of the Week {.smaller}
...
\end{table}
```
## DiD Results for Phoenix-Mesa, AZ {.smaller}
...
\end{table}
```
## DiD Results for Phoenix-Mesa in Each Day of the Week {.smaller}
...
\end{table}
```
## DiD with Two Treated Cities {.smaller}

![](images/timeline.png){fig-align="center" width="50%"}

...
$P_{it}=\gamma (D_i \times Operating_t) + W'_{it} \beta + \alpha_i + \mu_{it} + \kappa_{t} + \epsilon{it}$
...
-   $Operating_t = 1$ when the light rail system in the treated city has opened and $Operating_t = 0$ before construction has started.
...
-   Our standard errors may be underestimated because we only have 10 cities and 10 clusters.
    ...
    -   We are exploring using synthetic control to recalculate the impacts or

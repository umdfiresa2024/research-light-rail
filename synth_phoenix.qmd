...
dataprep.out <-
  dataprep(
    df5,
    predictors            = colnames(df5)[c(5:34, 36:38)], #add linear, square, cubic weather
    dependent             = "pm25",
    unit.variable         = "add_num",
    time.variable         = "time",
    unit.names.variable   = "Address",
    treatment.identifier  = 19 , #value in add_num column
    controls.identifier   = c(1:3, 9:12, 14, 15, 17, 20, 21, 23:26), 
...
png("Presentation/images/synth_az_annualavg.png", 
...
dataprep.out <-
  dataprep(df5,   
    predictors            = colnames(df5)[c(6:36, 39:43, 45:46)], 
    dependent             = "pm25",
    unit.variable         = "add_num",
    time.variable         = "time",
    unit.names.variable   = "Address",
...
dataprep.out <-
  dataprep(
    df5,
    predictors            = colnames(df5)[c(6:31, 34:36)], 
    dependent             = "pm25",
    unit.variable         = "add_num",
    time.variable         = "time",
    unit.names.variable   = "Address",
...
dataprep.out <-
  dataprep(
    df5,
    predictors            = colnames(df5)[c(6:31, 34:36)], #add linear, square, cubic weather
    dependent             = "pm25",
    unit.variable         = "add_num",
    time.variable         = "time",
    unit.names.variable   = "Address",
...
```{r}
png("Presentation/images/synth_az_Julyavg.png", 
    res=500, width=5, height=5, units="in")

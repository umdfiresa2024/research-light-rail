...
df <- data.frame(event = c("NC Construction", "NC Expansion", "AZ Construction", "AZ Expansion", "PM2.5 Data", "Operating=0", "Operating=1"),
...
png("Presentation/images/timeline.png", 
    res=500, width=6, height=1.8, units="in")

gg_vistime(df, col.group="group", linewidth=10)

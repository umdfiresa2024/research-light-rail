...
df3 <- df |>
  filter(Address=="Flagstaff, AZ" | Address=="Phoenix-Mesa, AZ" | 
           ...
           Address=="Las Cruces, NM" | Address=="Winston-Salem, NC" | 
...
df5<-as.data.frame(df5) |>
  ...
  rename(Y=pm25, X1=Rainf_tavg, X2=CO2)
...
dataprep.out <-
  dataprep(
    ...
    treatment.identifier  = c(3, 11) , #value in add_num column
    controls.identifier   = c(1:2, 4:10, 12:13), #value of other control cities
